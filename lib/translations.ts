  ...
  es: {
    ...
    cashflow: {
      ...
      import: {
        ...
        summaryReady:
          "Importación preparada. Se ha actualizado el flujo de caja y se ha generado un log pendiente de guardar.",
  ...
  en: {
    ...
    cashflow: {
      ...
      import: {
        ...
        summaryReady:
          "Import prepared. Cashflow was updated and a pending log file was generated.",
