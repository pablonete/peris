...
export interface Expense {
  ...
  concept: string
  subtotal: number
  vat: VatItem[] // array of VAT items (1-3 typically)
  irpf: number | null // IRPF withholding (15% typical)
  total: number
  paymentDate: string | null
}
  ...
  "2025.4Q": {
    ...
    expenses: [
      ...
      },
      {
        ...
        subtotal: 1000.0,
        vat: [
          { rate: 10, amount: 100.0 },
          { rate: 21, amount: 189.0 },
        ],
        irpf: null,
        total: 1289.0,
