...
- 💵 **Cashflow View** - Monitor bank balance and transaction flow over time with multi-bank support, category tagging, and Revolut CSV imports from the repository `import/` folder
